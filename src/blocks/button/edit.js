		...
		<div { ...useBlockProps() }>
			...
			<InspectorControls>
				...
				<PanelBody
					...
					initialOpen={ false }
					opened={ panelOpen[ 'textshadow' ] }
					onToggle={ () => {
						closePanels( 'textshadow' );
					} }
				>
					<ToggleControl
				...
				<PanelBody
					...
					initialOpen={ false }
					className="grigora-icons-panel"
					opened={ panelOpen[ 'icon' ] }
					onToggle={ () => {
						closePanels( 'icon' );
					} }
				>
