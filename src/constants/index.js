...
export const particlesDefaultConfig1 = {
	fullScreen: {
		enable: false,
	},
	background: {
...
export const particlesDefaultConfig2 = {
    fpsLimit: 60,
...
export const particlesDefaultConfig3 = {
    particles: {
      color: {
        value: "#FF0000",
        animation: {
...
export const particlesDefaultConfig4 =  {
	detectRetina: false,
	fpsLimit: 60,
	interactivity: {
	  detectsOn: "canvas",
...
export const particlesDefaultConfig5 = {
	detectRetina: false,
	fpsLimit: 30,
	interactivity: {
	  detectsOn: "canvas",
