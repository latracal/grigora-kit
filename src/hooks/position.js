             ...
             if ( hasSupport && props.isSelected ) {
                 ...
                 return (
                     <>
                         <BlockEdit { ...props } />
                            <InspectorControls>
                                <PanelBody title={ __( 'Position', 'grigora-kit' ) } className={'position_panel'} initialOpen={false}>
                                <GrigoraSelectInput
                                ...
                                <GrigoraNumberInput
                                    label="Z Index"
                                    onChange={ ( zindex ) => setAttributes( { zindex: zindex.toString() } ) }
                                    value={ zindex }
                                    resetValue={ '' }
                                />
                                </PanelBody>
...
export function addEditProps( settings ) {
    if (
        hasBlockSupport( settings, 'grigoraPosition', false )
    ) {
...
addFilter( 'blocks.registerBlockType', 'grigora-kit/grigoraPosition/attribute', addAttribute );
addFilter(
    'editor.BlockEdit',
