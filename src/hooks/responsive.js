...
import isEmpty from '@helpers/objEmpty';
 ...
 export const withInspectorControl = createHigherOrderComponent(
     ( BlockEdit ) => {
         return ( props ) => {
             const hasSupport = hasBlockSupport( props.name, 'grigoraResponsive' );
...
export function addSaveProps( extraProps, blockType, attributes ) {
    if (
        ...
        (attributes.hideDesktop || attributes.hideTablet || attributes.hideMobile)
    ) {
 ...
 addFilter( 'blocks.registerBlockType', 'grigora-kit/grigoraResponsive/attribute', addAttribute );
 addFilter(
     'editor.BlockEdit',
