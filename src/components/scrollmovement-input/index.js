...
function ScrollMovementAnimationControl( { value, onChange } ) {
	...
	return (
		<div className={ `grigora-scrollmovement-input` }>
			{ /* Vertical */ }
			<HStack spacing={ 4 }>
				<div className="grigora-scrollmovement-input__label">
					{ __( 'Vertical Movement', 'grigora-kit' ) }
				</div>
				<div>
			...
			<HStack spacing={ 4 }>
				<div className="grigora-scrollmovement-input__label">
					{ __( 'Horizontal Movement', 'grigora-kit' ) }
				</div>
				<div>
