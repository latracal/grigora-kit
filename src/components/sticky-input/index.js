...
function StickyControl( {
	...
	const [ inside, setInside ] = useState( value.inside ? value.inside : false );
	...
	useEffect( () => {
		onChange( { offset, inside, parent: parent ? parent : undefined, hideDesktop, hideTablet, hideMobile } );
	...
	return (
		...
		{ inside && (
			<>
			<Notice text={__( 'By default, the immediate parent container will be referenced. Use the \'CSS Selector\' from below to target the custom closest parent.', 'grigora-kit' )} status={'success'} />
			<TextControl
