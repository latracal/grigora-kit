import { __experimentalBorderBoxControl as BorderBoxControl,
...
function GrigoraBorderBoxInput( { value, onChange, label = "", resetValue={"top":{color: '#72aee6', style: 'dashed', width: '0px'}, "bottom":{color: '#72aee6', style: 'dashed', width: '0px'}, "right":{color: '#72aee6', style: 'dashed', width: '0px'}, "left":{color: '#72aee6', style: 'dashed', width: '0px'}} } ){
