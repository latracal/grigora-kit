...
function GrigoraBorderRadiusInput( { values, onChange, label = "", resetValue={ "topLeft": "4px", "topRight": "4px", "bottomLeft": "4px", "bottomRight": "4px" } }){

    return(
        <div className={`grigora-borderradius-input`}>
            <HStack spacing={ 4 } className={`grigora-borderradius-input__hstack`}>
            <div className='grigora-borderradius-input__label'>{label}</div>
