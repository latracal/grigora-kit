...
if ( ! function_exists( 'grigora_kit_block_init' ) ) {
	...
	function grigora_kit_block_init() {
		...
		wp_register_style( 'grigora-kit-lottie', GRIGORA_KIT_URL . 'assets/css/blocks/lottie/style' . $ext, array(), $ver );
		...
		wp_register_style( 'grigora-kit-editor-lottie', GRIGORA_KIT_URL . 'assets/css/blocks/lottie/editor' . $ext, array(), $ver );
		...
		register_block_type(
			GRIGORA_KIT_PATH . '/build/blocks/lottie/block.json',
			array(
				'style'        => 'grigora-kit-lottie',
				'editor_style' => 'grigora-kit-editor-lottie',
				'supports'     => array(
					'grigoraMotion'     => true,
					'grigoraSticky'     => true,
					'grigoraResponsive' => true,
