                                                ...
                                                setTimeout(() => {
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        data: {
                                                            ...
                                                            'site_name': site_name ? site_name.value : undefined,
                                                            'site_tagline': site_tagline? site_tagline.value : undefined,
                                                            'site_logo': site_logo? site_logo.value : undefined,
                                                            'site_logosize': site_logosize? site_logosize.value : undefined,
                                                            'color_background': color_background? color_background.value : undefined,
                                                            'color_canavas': color_canavas? color_canavas.value : undefined,
                                                            'color_foreground': color_foreground? color_foreground.value : undefined,
                                                            'color_primary': color_primary? color_primary.value : undefined,
                                                            'color_secondary': color_secondary? color_secondary.value : undefined,
                                                            'color_button': color_button? color_button.value : undefined,
                                                            'color_button_text': color_button_text? color_button_text.value : undefined,
                                                            'font_family': font_family? font_family.value : undefined,
                                                            'font_size': font_size? font_size.value : undefined,
                                                            'container_width': container_width? container_width.value : undefined,
                                                            'block_gap': block_gap? block_gap.value : undefined
                                                        },
                                                    })
                                                        .done(function (result) {
                                                            if( import_demo_vars.debug ){
