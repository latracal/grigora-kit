...
window.addEventListener( 'load', function () {
	...
	function i( t, i, a, n, s, e, r, o ) {
		...
		o &&
			( l.formattingFn = function ( t ) {
				return `${ s }${ Intl.NumberFormat( 'en', {
					notation: 'compact',
				} ).format( t ) }${ e }`;
			} ),
			new CountUp( t, a, l );
	...
	for ( var a = 0; a < t.length; a++ ) {
		i(
			...
			t[ a ].dataset.prefix,
			t[ a ].dataset.suffix,
			t[ a ].dataset.tseparator,
			'true' === t[ a ].dataset.format
		);
	}
} );
